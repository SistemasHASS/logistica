...
export class LayoutComponent {
  ...
  private readonly ROUTE_GROUP_MAP: Record<string, string> = {
    ...
    'dashboard-despacho': 'panel',
    'dashboard-tilogist': 'panel',
    'dashboard-adlogist': 'panel',
    'dashboard-jemlogist': 'panel',
    'dashboard-finanzas': 'panel',
    ...
    'conformidad-servicios': 'compras',
    'despachos': 'almacen',
    'recepcion-mercaderia': 'almacen',
    'kardex': 'almacen',
    'conformidad-almacen': 'almacen',
