...
const MENUS_LAYOUT: MenuItem[] = [
  ...
  { id: 'consolidacion-servicios', nombre: 'Consolidación Servicios',   icono: 'bx bx-wrench',        ruta: '/main/consolidacion-servicios', roles: ['TILOGIST','ADLOGIST','JLOLOGIST','JEMLOGIST','LOLOGIST'],                       categoria: 'Compras & Órdenes', orden: 17 },
  { id: 'solicitudes-servicio',  nombre: 'Solicitudes de Servicio',     icono: 'bx bx-briefcase',     ruta: '/main/solicitudes-servicio',  roles: ['TILOGIST','ADLOGIST','JLOLOGIST','JEMLOGIST','LOLOGIST'],                         categoria: 'Compras & Órdenes', orden: 18 },
  { id: 'ordenes-servicio',     nombre: '\u00d3rdenes de Servicio',          icono: 'bx bx-wrench',        ruta: '/main/ordenes-servicio',     roles: ['TILOGIST','ADLOGIST','JLOLOGIST','JEMLOGIST','LOLOGIST'],                        categoria: 'Compras & Órdenes', orden: 19 },
  { id: 'cotizaciones',          nombre: 'Cotizaciones',                 icono: 'icon icon-calculator', ruta: '/main/cotizaciones',          roles: ['TILOGIST','ADLOGIST','JLOLOGIST','JEMLOGIST','LOLOGIST'],                                           categoria: 'Compras & Órdenes', orden: 20 },
  { id: 'conformidad-servicios',nombre: 'Conformidad de OS',            icono: 'bx bx-check-shield',   ruta: '/main/conformidad-servicios', roles: ['TILOGIST','ADLOGIST','JLOLOGIST','JEMLOGIST','LOLOGIST','EMLOGIST'],                                 categoria: 'Compras & Órdenes', orden: 21 },
  // ── Almacén & Stock ───────────────────────────────────────────
