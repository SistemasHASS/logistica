...
@Component({
  selector: 'app-modal-detalle-activo-menor',
  standalone: true,
  styleUrls: ['../../requerimientos.component.scss'],
  imports: [CommonModule, FormsModule, DropdownComponent],
  templateUrl: './modal-detalle-activo-menor.component.html',
})
export class ModalDetalleActivoMenorComponent {
  // Visibilidad del modal
  @Input() visible = false;
  @Input() modoEdicion = false;
  // Línea temporal del formulario de detalle ACTIVO FIJO MENOR
  @Input() lineaTempActivoFijoMenor: any = {};
  ...
  // Guarda la línea de detalle ACTIVO FIJO MENOR
